...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_libphonenumber_js__ = __webpack_require__(/*! libphonenumber-js */ 46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_all_countries__ = __webpack_require__(/*! ./assets/all-countries */ 59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_default_country__ = __webpack_require__(/*! ./assets/default-country */ 60);
  ...
  mounted: function mounted() {
    ...
    this.initializeCountry().then(function () {
      if (!_this3.phone && _this3.inputOptions && _this3.inputOptions.showDialCode && _this3.activeCountry) {
        _this3.phone = '+' + _this3.activeCountry.dialCode;
      }
    ...
    initializeCountry: function initializeCountry() {
      ...
      return new Promise(function (resolve) {
        ...
        if (_this4.phone && _this4.phone[0] === '+') {
          var parsedPhone = Object(__WEBPACK_IMPORTED_MODULE_0_libphonenumber_js__["d" /* parsePhoneNumberFromString */])(_this4.phone);
...
module.exports = __webpack_require__(/*! /root/project/demo/index.js */38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(/*! vue */ 39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_vue_tel_input_vue__ = __webpack_require__(/*! ../src/vue-tel-input.vue */ 43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__App_vue__ = __webpack_require__(/*! ./App.vue */ 62);
